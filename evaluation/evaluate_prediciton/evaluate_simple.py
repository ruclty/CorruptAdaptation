...
def thread_run(config, train_data, test_data):
    ...
    mlp_prob_test_y = model.predict(scaled_test_x)
    mlp_pred_test_y = model.predict_classes(scaled_test_x)
    print(mlp_pred_test_y)
